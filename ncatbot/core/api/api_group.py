...
class GroupAPI(BaseAPI):
    ...
    def set_group_kick_sync(
        ...
        return run_func_sync(self.set_group_kick, group_id, user_id, reject_add_request)
    ...
    def set_group_ban_sync(
        ...
        return run_func_sync(self.set_group_ban, group_id, user_id, duration)

    def set_group_whole_ban_sync(self, group_id: Union[str, int], enable: bool) -> None:
        return run_func_sync(self.set_group_whole_ban, group_id, enable)

    def set_group_admin_sync(
        self, group_id: Union[str, int], user_id: Union[str, int], enable: bool
    ) -> None:
        return run_func_sync(self.set_group_admin, group_id, user_id, enable)

    def set_group_leave_sync(
        self, group_id: Union[str, int], is_dismiss: bool = False
    ) -> None:
        return run_func_sync(self.set_group_leave, group_id, is_dismiss)
    ...
    def set_group_add_request_sync(
        ...
        return run_func_sync(self.set_group_add_request, flag, approve, reason)

    def set_group_card_sync(
        self, group_id: Union[str, int], user_id: Union[str, int], card: str = ""
    ) -> None:
        return run_func_sync(self.set_group_card, group_id, user_id, card)

    def set_essence_msg_sync(self, message_id: Union[str, int]) -> None:
        return run_func_sync(self.set_essence_msg, message_id)

    def delete_essence_msg_sync(self, message_id: Union[str, int]) -> None:
        return run_func_sync(self.delete_essence_msg, message_id)

    def get_group_essence_msg_sync(self, group_id: Union[str, int]) -> List[dict]:
        return run_func_sync(self.get_group_essence_msg, group_id)
    ...
    def post_group_file_sync(
        ...
        return run_func_sync(self.post_group_file, group_id, image, record, video, file)
    ...
    def trans_group_file_sync(self, group_id: Union[str, int], file_id: str) -> None:
        return run_func_sync(self.trans_group_file, group_id, file_id)

    def rename_group_file_sync(
        self, group_id: Union[str, int], file_id: str, new_name: str
    ) -> None:
        return run_func_sync(self.rename_group_file, group_id, file_id, new_name)

    def get_file_sync(self, file_id: str, file: str) -> File:
        return run_func_sync(self.get_file, file_id, file)

    def upload_group_file_sync(
        self, group_id: Union[str, int], file: str, name: str, folder
    ) -> str:
        return run_func_sync(self.upload_group_file, group_id, file, name, folder)

    def create_group_file_folder_sync(
        self, group_id: Union[str, int], folder_name: str
    ) -> None:
        return run_func_sync(self.create_group_file_folder, group_id, folder_name)

    def group_file_folder_makedir_sync(
        self, group_id: Union[str, int], path: str
    ) -> str:
        return run_func_sync(self.group_file_folder_makedir, group_id, path)

    def delete_group_file_sync(self, group_id: Union[str, int], file_id: str) -> None:
        return run_func_sync(self.delete_group_file, group_id, file_id)

    def delete_group_folder_sync(
        self, group_id: Union[str, int], folder_id: str
    ) -> None:
        return run_func_sync(self.delete_group_folder, group_id, folder_id)

    def get_group_root_files_sync(
        self, group_id: Union[str, int], file_count: int = 50
    ) -> dict:
        return run_func_sync(self.get_group_root_files, group_id, file_count)
    ...
    def get_group_file_url_sync(self, group_id: Union[str, int], file_id: str) -> str:
        return run_func_sync(self.get_group_file_url, group_id, file_id)
