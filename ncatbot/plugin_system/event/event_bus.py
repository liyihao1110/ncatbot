...
from ncatbot.plugin_system.event import Event
from ncatbot.plugin_system.utils.pluginsys_err import EventHandlerError
...
class EventBus:
    ...
    async def _run_hooks(
        self, hook_type: str, event: Event, handler=None, *args, **kwargs
    ) -> None:
        """运行指定类型的钩子函数"""
        hooks_to_run = []
